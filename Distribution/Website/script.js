...
const translations = {
  en: {
    ...
    'BookmarkBridge compare vos favoris et utilise le workflow le plus sûr pour chaque direction, directement sur votre Mac et sans cloud.': 'BookmarkBridge compares your bookmarks and uses the safest workflow for each direction, directly on your Mac and without the cloud.',
    'Enfin reliés.': 'Finally connected.',
    'Bêta gratuite 0.9.4 (build 1) · macOS 26.5 minimum.': 'Free beta 0.9.4 (build 1) · macOS 26.5 or later.',
    ...
    'Safari → Chrome est transactionnel. Chrome → Safari prépare un fichier HTML que Safari importe lui-même.': 'Safari → Chrome is transactional. Chrome → Safari prepares an HTML file that Safari imports itself.',
    ...
    'Version 0.9.4 (build 1) · macOS 26.5 minimum · environ 9,96 Mio.': 'Version 0.9.4 (build 1) · macOS 26.5 or later · about 9.96 MiB.',
  ...
  es: {
    ...
    'BookmarkBridge compare vos favoris et utilise le workflow le plus sûr pour chaque direction, directement sur votre Mac et sans cloud.': 'BookmarkBridge compara tus marcadores y utiliza el flujo más seguro para cada dirección, directamente en tu Mac y sin nube.',
    'Enfin reliés.': 'Por fin conectados.',
    'Bêta gratuite 0.9.4 (build 1) · macOS 26.5 minimum.': 'Beta gratuita 0.9.4 (build 1) · macOS 26.5 o posterior.',
    ...
    'Safari → Chrome est transactionnel. Chrome → Safari prépare un fichier HTML que Safari importe lui-même.': 'Safari → Chrome es transaccional. Chrome → Safari prepara un archivo HTML que Safari importa por sí mismo.',
    ...
    'Version 0.9.4 (build 1) · macOS 26.5 minimum · environ 9,96 Mio.': 'Versión 0.9.4 (build 1) · macOS 26.5 o posterior · unos 9,96 MiB.',
  ...
  de: {
    ...
    'BookmarkBridge compare vos favoris et utilise le workflow le plus sûr pour chaque direction, directement sur votre Mac et sans cloud.': 'BookmarkBridge vergleicht Ihre Lesezeichen und verwendet für jede Richtung den sichersten Workflow – direkt auf Ihrem Mac und ohne Cloud.',
    'Enfin reliés.': 'Endlich verbunden.',
    'Bêta gratuite 0.9.4 (build 1) · macOS 26.5 minimum.': 'Kostenlose Beta 0.9.4 (Build 1) · ab macOS 26.5.',
    ...
    'Safari → Chrome est transactionnel. Chrome → Safari prépare un fichier HTML que Safari importe lui-même.': 'Safari → Chrome ist transaktional. Chrome → Safari erstellt eine HTML-Datei, die Safari selbst importiert.',
    ...
    'Version 0.9.4 (build 1) · macOS 26.5 minimum · environ 9,96 Mio.': 'Version 0.9.4 (Build 1) · ab macOS 26.5 · ca. 9,96 MiB.',
